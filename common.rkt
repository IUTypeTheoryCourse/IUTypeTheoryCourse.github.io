...
(define topic-dict
  `((,first-tues              . "Propositional logic")
    ...
    (,(+weeks first-thurs 4)  . "Dependent types: intro")
    (,(+weeks first-tues 5)   . "Dependent types: implementation")
    (,(+weeks first-thurs 5)  . "Dependent types: Σ, =")
    (,(+weeks first-tues 6)   . "Inductive types")
    (,(+weeks first-thurs 6)  . "Universes")))
